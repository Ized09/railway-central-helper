...
model_options = {
    ...
    "Sonnet 5 (Balanced & Fast)": "claude-sonnet-5"
}
    ...
    with col2:
        if st.session_state.selected_slug:
            ...
            if selected_node:
                ...
                if st.button(f"🤖 Generate with {selected_model_name}", type="primary"):
                    with st.spinner(f"{selected_model_name} reviewing..."):
